...
public class SlenHud extends ConsoleHost implements DTarget, DropTarget,
	...
	public SlenHud(Coord c, Widget parent) {
		...
		if (!Config.new_minimap) {
			...
			new MiniMap(new Coord(5, 5), new Coord(125, 125), this, ui.mapview);
		} else {
			new MinimapPanel(Coord.z, Coord.z, ui.root);
		}
		vc = new VC(this, fb = new FoldButton(new Coord(
				(MainFrame.innerSize.width - 40) / 2,
				MainFrame.innerSize.height), parent) {
			public void click() {
				vc.show();
			}
		});
