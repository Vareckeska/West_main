...
public class OptWnd extends Window {
    ...
    private static final BufferedImage cfgimgu = Resource
            .loadimg("gfx/hud/buttons/centeru");
    private static final BufferedImage cfgimgd = Resource
            .loadimg("gfx/hud/buttons/centerd");
	...
	{ /* GENERAL TAB */
		...
		(new CheckBox(new Coord(142, 25), tab, "Toggle CA on login") {
		...
		(new CheckBox(new Coord(142, 55), tab, "Toggle tracking on login") {
			public void changed(boolean val) {
			    Config.toggleTR = val;
			    Config.saveOptions();
			}
	    ...
	    (new CheckBox(new Coord(220, 410), tab, "Automatically save minimaps") {
		public void changed(boolean val) {
	...
	{ /* HIDE OBJECTS TAB */
        ...
        { /* HIGHLIGHT OPTIONS TAB */
            ...
            for (final String group : Config.hlgroups.keySet()) {
                final CheckBox chkbox = new CheckBox(new Coord(20, 30 * i),
                        tab, group) {
                    public void changed(boolean val) {
                        if (val) {
                            Config.highlightItemList.addAll(Config.hlcgroups
                                    .get(group));
                        } else {
                            Config.highlightItemList.removeAll(Config.hlgroups
                                    .get(group));
                        }
                        Config.saveOptions();
                    }
                ...
                chkbox.a = Config.highlightItemList
                        .containsAll(Config.hlcgroups.get(group));
                ...
                new IButton(new Coord(1, 30 * i + 17), tab, cfgimgu, cfgimgd) {
                    ...
                    public void click() {
                        ...
                        wnd.setData(Config.hlgroups.get(group),
                                Config.hlcgroups.get(group), new SelectorWnd.Callback() {

                                    @Override
                                    public void callback() {
                                        v = false;
                                        Config.highlightItemList
                                                .removeAll(Config.hlgroups
                                                        .get(group));
                                        if (chkbox.a) {
                                            Config.highlightItemList
                                                    .addAll(Config.hlcgroups
                                                            .get(group));
                                        }
            ...
            CheckBox chkbox = new CheckBox(new Coord(150, 30), tab,
                    "Don't scale minimap icons") {
                public void changed(boolean val) {
