...
public class Config {
    ...
    public static boolean simplemap;
    public static boolean runFlaskSuppression;
    public static boolean showAURA = true;
    public static boolean showBOX2 = true;
    public static boolean autoaggro = false;
    public static boolean aggrounknown = true;
    public static boolean aggrored = true;
    public static boolean alarmunknown = true;
    public static boolean alarmred = true;
    public static boolean alarm = true;
    public static boolean debug = false;
    public static boolean radar = true;
    public static boolean dontScaleMMIcons = true;
    public static boolean showViewDistance = true;
    public static String buglog = "";
    public static boolean GobColor;
    public static boolean muteChat = false;
    public static boolean showgobpath;
    public static boolean showothergobpath = true;
    public static boolean CWind = false;
