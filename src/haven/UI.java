...
public class UI {
    ...
    public void uimsg(int id, String msg, Object... args) {
        if (Config.debug == true) {
            String sa = "id:" + Integer.toString(id) + ", args:";
            for (Object i : args)
                sa += i.toString() + " | ";
            System.err.println("uimsg " + msg + ", " + sa + ";");

            if (msg.equals("add") && !sa.isEmpty()) {
                Config.buglog += "A " + msg + ", " + sa + ";\r\n";
            }
        }
        Widget wdg;
        synchronized (this) {
        ...
        if (wdg != null) {
            ...
            // System.out.println("uimsg id:"+id+" msg:"+msg+" arg...");
        } else
            throw (new UIException("Uimsg to non-existent widget " + id, msg,
                    args));
    }
